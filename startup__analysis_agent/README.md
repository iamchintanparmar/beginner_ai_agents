...
1. Clone the repository:
   ```bash
   git clone https://github.com/iamchintanparmar/beginner_ai_agemts.git
   cd beginner_ai_agents/tartup__analysis_agent
   ```
...
| No analysis generated | Invalid or missing Anthropic API key | Re-check the key entered in the sidebar/environment |
| No news results | Network issue or DuckDuckGo rate limiting | Retry, or try a narrower search topic |

## Tech Stack

- **Frontend**: Streamlit
- **AI Model**: Claude 3.5 Sonnet (Anthropic)
- **News Collection**: DuckDuckGo
