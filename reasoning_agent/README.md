...
| No output / errors | Ollama not installed or not running | Install Ollama and confirm it's running before launching the app |
| Slow responses | Large model running locally | Try a smaller Ollama model or ensure sufficient system resources |
